  ...
  <div className='aboutshadow'>
    ...
    <Grid.Column>
      ...
      <Image src={one}/>
        ...
        <Button circular href='https://www.linkedin.com/in/liesbeth-kerstens-16535920/' color='linkedin' icon='linkedin'/>
      </Segment>
    </Grid.Column>
    <Grid.Column>
      <Segment>
        ...
        <Button circular  href='https://www.facebook.com/Casa-Familiar-Ecol%C3%B3gica-Pachachaca-635301843320489/' color='facebook' icon='facebook' />
        <Button circular href='https://www.linkedin.com/in/pavel-marmanillo-barrio-de-mendoza-92904325/' color='linkedin' icon='linkedin'/>  
      </Segment>
    </Grid.Column>
  </Grid>
  </div>
